...
pkgdatadir = $(datadir)/lsyncd
pkgincludedir = $(includedir)/lsyncd
pkglibdir = $(libdir)/lsyncd
pkglibexecdir = $(libexecdir)/lsyncd
...
am__append_1 = inotify.c
#am__append_2 = fsevents.c
subdir = .
...
am__objects_1 = inotify.$(OBJEXT)
#am__objects_2 = fsevents.$(OBJEXT)
...
ACLOCAL = ${SHELL} /usr/src/lsyncd-2.1.5/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /usr/src/lsyncd-2.1.5/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/src/lsyncd-2.1.5/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/src/lsyncd-2.1.5/missing --run automake-1.11
AWK = mawk
CC = gcc
...
LUAC51 = /usr/bin/luac5.1
LUAC52 = no
LUA_CFLAGS = -I/usr/include/lua5.1
LUA_LIBS = -llua5.1
MAKEINFO = ${SHELL} /usr/src/lsyncd-2.1.5/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = lsyncd
PACKAGE_BUGREPORT = axkibe@gmail.com
PACKAGE_NAME = lsyncd
PACKAGE_STRING = lsyncd 2.1.5
...
STRIP = 
VERSION = 2.1.5
abs_builddir = /usr/src/lsyncd-2.1.5
abs_srcdir = /usr/src/lsyncd-2.1.5
abs_top_builddir = /usr/src/lsyncd-2.1.5
abs_top_srcdir = /usr/src/lsyncd-2.1.5
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /usr/src/lsyncd-2.1.5/install-sh
...
include ./$(DEPDIR)/fsevents.Po
include ./$(DEPDIR)/inotify.Po
include ./$(DEPDIR)/lsyncd.Po
